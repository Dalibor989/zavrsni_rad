...
<?php
    ...
    $sql = "SELECT Id, Title, Body, Author FROM posts";
...
<div class="row">
  ...
  ?>
    ...
    <article class="va-c-article">
        <header>
            ...
            <div class="va-c-article__meta">28-07-1989 by <?php echo($post['Author']) ?></div>
        </header>
  ...
  ?>
    ...
    <!-- <div class="blog-post">
      <h2 class="blog-post-title"><a href="single-post.php"></a></h2>
